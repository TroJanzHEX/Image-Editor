...
async def black_border(client, message):
    ...
    await message.reply_to_message.reply_photo("imaged-black-border.png", quote=True)
...
async def green_border(client, message):
    ...
    await message.reply_to_message.reply_photo("imaged-green-border.png", quote=True)
...
async def blue_border(client, message):
    ...
    await msg.delete()
    await message.reply_chat_action("upload_photo")
    await message.reply_to_message.reply_photo("imaged-blue-border.png", quote=True)
...
async def red_border(client, message):
    ...
    await msg.delete()
    await message.reply_chat_action("upload_photo")
    await message.reply_to_message.reply_photo("imaged-red-border.png", quote=True)
