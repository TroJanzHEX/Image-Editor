...
async def rotate_90(client, message):
    ...
    await message.reply_to_message.reply_photo("rotate_90.jpg", quote=True)
...
async def rotate_180(client, message):
    ...
    await msg.delete()
    await message.reply_chat_action("upload_photo")
    await message.reply_to_message.reply_photo("rotate_180.jpg", quote=True)
...
async def rotate_270(client, message):
    ...
    await message.reply_to_message.reply_photo("rotate_270.jpg", quote=True)
